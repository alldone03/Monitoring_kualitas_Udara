    ...
    <section class="section">
        <div class="row">
            <div class="col-sm-12 col-md-4">
                <div class="card">
                    <div class="card-body ">
                        <div id="container-SUHU" class="chart-container d-flex justify-content-center"></div>
                    </div>
                </div>
            </div>
            <div class="col-sm-12 col-md-4">
                <div class="card">
                    <div class="card-body">
                        <div id="container-KELEMBABAN" class="chart-container d-flex justify-content-center"></div>
                    </div>
                </div>
            </div>
            <div class="col-sm-12 col-md-4">
                <div class="card">
                    <div class="card-body">
                        <div id="container-KualitasUdara" class="chart-container d-flex justify-content-center"></div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Graph Kelembaban</h5>
                            <div class="row justify-content-center">
                                <canvas id="Chart-KELEMBABAN"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Graph Kualitas Udara</h5>
                            <div class="row justify-content-center">
                                <canvas id="Chart-KualitasUdara"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
